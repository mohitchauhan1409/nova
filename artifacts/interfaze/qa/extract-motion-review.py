...
ranges=[('settings-motion',149.6,2,10,(1310,300,890,1430)),('output-motion',464.3,1.2,30,(340,310,1720,1410))]
...
(q/('decoded-motion-review-ranges.json' if len(sys.argv)>2 else 'motion-review-ranges.json')).write_text(json.dumps(ranges,indent=2)+'\n')

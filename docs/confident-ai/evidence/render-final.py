"""Reproduce the inspected Confident AI final edit; run only in a safe render window."""
...
MEDIA = ROOT / 'artifacts/confident-ai/media'
PRIVATE = Path('/Users/macbook/Desktop/Nova-batch-20260921/private/confident-ai/final-edit-qa')
PRIVATE.mkdir(parents=True, exist_ok=True)
SOURCE = MEDIA / 'nova-confident-ai-original.mov'
SILENT = MEDIA / 'nova-confident-ai-silent.mp4'
CLICKS = MEDIA / 'nova-confident-ai-clicks.mp4'
...
with tempfile.TemporaryDirectory(prefix='nova-confident-ai-final-') as scratch:

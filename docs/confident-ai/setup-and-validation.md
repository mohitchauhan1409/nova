...
5. Confirm the saved baseline, dark theme, native side panel, launcher hide/show, focus, actual editor input and one real cursor click/scroll through a short capture before rehearsal. The final raw capture subsequently completed; export/cursor QA is tracked by the media editor separately.

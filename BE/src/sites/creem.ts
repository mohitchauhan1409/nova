...
EVIDENCE: Distinguish UI inspection, operator-created setup, and workflows actually executed by Nova. Home revenue, customer count, MRR and payments come from sandbox checkouts. Never fabricate metrics, historical activity or customers. No exhaustive-coverage claims. Completion requires saved values, exact object identity and persistence, not a changed URL or success toast.`,
  flows: [
    { id: 'creem-product', name: 'Set up a product', trigger: 'Help me set up a subscription product in Test mode.', verified: false, steps: [
    ...
    { id: 'creem-offer', name: 'Create a targeted offer', trigger: 'Create a discount for one of my products in Test mode.', verified: false, steps: [
    ...
    { id: 'creem-report', name: 'Review store activity', trigger: 'Summarize the current store activity and show me the saved products.', verified: false, steps: [

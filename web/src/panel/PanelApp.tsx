...
export function PanelApp() {
  ...
  return <main className="np-app" data-site={hostname} data-color-scheme={session?.lastSnapshot?.theme.scheme || 'light'} aria-label="Nova side panel" style={{'--site-accent':palette.accent,'--site-ink':palette.ink,'--site-soft':palette.soft} as CSSProperties}>

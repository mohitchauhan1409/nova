...
export const launcherMark = `<svg viewBox="0 0 64 64" aria-hidden="true" focusable="false">
  ...
  <g class="nova-eyes">
    ...
    <g class="nova-gaze">
      <ellipse cx="24" cy="31" rx="4.6" ry="7" fill="url(#nova-pupil)"/>
      <ellipse cx="44" cy="30" rx="4.3" ry="6.7" fill="url(#nova-pupil)"/>
      <ellipse cx="22.8" cy="28.4" rx="1.5" ry="2" fill="#ffffff" opacity=".96"/>
      <ellipse cx="42.8" cy="27.4" rx="1.4" ry="1.8" fill="#ffffff" opacity=".96"/>
    </g>
  </g>
</svg>`;
